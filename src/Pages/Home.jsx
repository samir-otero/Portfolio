...
const WORDS = ["Eager to innovate", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/samir-otero" },
  { icon: Linkedin, link: "www.linkedin.com/in/samir-otero" },
  { icon: Instagram, link: "https://www.instagram.com/samir_otero_carvajal/" }
];
